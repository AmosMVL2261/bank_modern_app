  ...
  return (
      ...
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        <div className='flex flex-row justify-between items-center w-full'>
          ...
          {/* Get Started Button for desktop devices */}
      ...
      {/* Render the right side of the Hero section (the images and effects) */}
      <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 h-[100%] relative`}>
